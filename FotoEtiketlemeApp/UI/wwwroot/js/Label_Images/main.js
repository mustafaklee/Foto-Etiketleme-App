...
import { loadPhotos, setupNavigation } from "./photoViewer.js";
import { resetAnnotations, getSelectedFindings, getSelectedBirads } from "./annotation.js";
    ...
    try {
        ...
        setupNavigation({
            onNext: () => {
                ...
                const selectedBirads = getSelectedBirads();
                console.log("📥 Kaydedilen:", { selectedFindings, selectedBirads });
                resetAnnotations();
            }
        });
